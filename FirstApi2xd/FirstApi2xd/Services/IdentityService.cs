    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            if (exists != null)
            {
                ...
                {
                    Errors = new[] {"User with this existing email address already exists"}
                };
            }
        ...
        {
            // Video 13 - Min 12:20
            var validatedToken = GetPrincipalForToken(token);
        ...
        private ClaimsPrincipal GetPrincipalForToken(string token)
        {
        ...
        {
            // Valida el algoritmo de encriptacion de la token
